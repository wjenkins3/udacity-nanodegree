...
dtce = tree.DecisionTreeClassifier(class_weight=None, criterion='entropy', max_depth=None,
            max_features=None, max_leaf_nodes=None, min_samples_leaf=1,
            min_samples_split=4, min_weight_fraction_leaf=0.0,
            presort=False, random_state=None, splitter='best')

dtc = tree.DecisionTreeClassifier(class_weight=None, criterion='gini', max_depth=None,
            max_features=None, max_leaf_nodes=None, min_samples_leaf=1,
            min_samples_split=4, min_weight_fraction_leaf=0.0,
            presort=False, random_state=None, splitter='best')

dt = tree.DecisionTreeClassifier(class_weight=None, criterion='entropy', max_depth=None,
            max_features=None, max_leaf_nodes=None, min_samples_leaf=1,
            min_samples_split=4, min_weight_fraction_leaf=0.0,
            presort=False, random_state=None, splitter='best')
...
bdt = ensemble.AdaBoostClassifier(base_estimator=dt)

classifiers = [gaussnb, dtc, dtce, knn, bdt]
...
params = {'base_estimator__max_leaf_nodes':[None,2,3,5],
          'base_estimator__max_features':[None,0.917,0.833,0.75],
          'base_estimator__min_samples_leaf':[1,2,3,4],
          'base_estimator__min_samples_split':[1,2,4],
          'base_estimator__min_weight_fraction_leaf':[0.0, 0.01, 0.001],
          'n_estimators':[30, 50, 60, 70, 75, 80],
          'learning_rate':[0.625, 0.65, 0.675, 0.688, 0.70, 1.000]}
